...
const about=()=>{
    ...
    <div>
        <Head>
            <title>Chakrit | About Page</title>
            <meta name='description' content='anything'/>
        </Head>
        <TransitionEffect/>
        <main className={'flex w-full flex-col items-center justify-center dark:text-light'}>
            <Layout className={'pt-10'}>
                <AnimatedText text='Passion Fuels Purpose! ' className='mb-16 lg:!text-5xl md:!text-4xl sm:!text-3xl xs:!text-2xl'/>
                <div className='grid w-full grid-cols-8 gap-16 sm:gap-8 '>
                    <div className='col-span-3 flex flex-col item-start justify-start xl:col-span-4 
                    ...
                    <div className='col-span-3 relative h-max  rounded-full border-2 border-solid border-dark bg-blue-100 p-8 xl:col-span-4 md:col-span-8'>
                        <Image src={Q_display} alt='Chakrit' className='w-full h-auto rounded-full border-2 border-solid border-dark md:order-1'/>
                    </div>
                    <div className='col-span-2 flex flex-col items-end justify-between
                    xl:col-span-8 xl:items-center xl:flex-row md:order-3 md:items-start'>
                        ...
                        <div className='flex flex-col items-end justify-center'>
                            ...
                            <h2 className=' text-xl font-medium capitalize text-dark/75 dark:text-light
                            xl:text-center md:text-lg sm:text-base xs:text-sm'>Experiences</h2>
                        </div>
                    </div>
                </div>
                <Skills/>
